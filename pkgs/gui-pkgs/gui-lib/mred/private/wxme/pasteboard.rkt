        ...
        (when ok?
          ...
          (let ([snip (if (send snip is-owned?)
            ...
            (let ([loc (make-loc
              ...
              (when (object=? (snip->style snip) ; should this be object=?
                    ...
                    (let ([old-style (snip->style snip)])
                      (let ([x (+ (loc-x loc) dx)]
                        ...
                        (send snip draw
                              ...
                              (if (and s-caret-snip (object=? snip s-caret-snip))
                                  show-caret
                                  'no-caret))
